...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('woa_date', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('woa_start_date', models.CharField(blank=True, max_length=10, null=True)),
                ('woa_end_date', models.CharField(blank=True, max_length=10, null=True)),
