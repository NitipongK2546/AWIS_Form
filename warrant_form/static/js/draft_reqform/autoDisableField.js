const cause_type_id_1 = document.getElementById("id_cause_type_id_1");
const cause_type_id_2 = document.getElementById("id_cause_type_id_2");
const cause_text_1 = document.getElementById("id_cause_text_1");
const cause_text_2 = document.getElementById("id_cause_text_2");

const have_req_1 = document.getElementById("id_have_req_1");
const have_req_2 = document.getElementById("id_have_req_2");
